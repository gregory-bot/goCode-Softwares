...
function AdminDashboard() {
  ...
  const [staffFilterDepartment, setStaffFilterDepartment] = useState('all');
  ...
  useEffect(() => {
    ...
    if (staffFilterDepartment !== 'all') {
      result = result.filter(member => member.department === staffFilterDepartment);
    }

    // Apply status filter
    if (staffFilterStatus !== 'all') {
      result = result.filter(member => member.status === staffFilterStatus);
    }
    
    setFilteredStaff(result);
  }, [staffSearchTerm, staffFilterDepartment, staffFilterStatus, staff]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage projects, budgets, staff, and user activities</p>
          </div>
          <div className="flex space-x-3">
            <button
              onClick={() => setShowStaffModal(true)}
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-4 py-2 rounded-lg transition-all flex items-center"
            >
        ...
        <div className="flex space-x-1 mb-8 bg-gray-100 p-1 rounded-lg">
          {[
            ...
            { id: 'budgets', label: 'Budget Allocations', icon: DollarSign }
          ].map((tab) => (
            <button
              key={tab.id}
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    onChange={(e) => setStaffFilterDepartment(e.target.value)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredStaff.map((staffMember) => (
                  <div key={staffMember.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    <div className="flex items-center mb-4">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-2 px-3 rounded-lg text-sm transition-colors flex items-center justify-center"
                      >
                        <Edit3 className="h-4 w-4 mr-1" />
                        Edit
                      </button>
                      <button
                        onClick={() => setDeleteStaffConfirm(staffMember)}
                        className="flex-1 bg-red-500 hover:bg-red-600 text-white py-2 px-3 rounded-lg text-sm transition-colors flex items-center justify-center"
                      >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        placeholder="e.g., Research Assistant, Project Manager"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Monthly Salary (KES)</label>
                      <input
                        type="number"
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  Are you sure you want to delete staff member <strong>{deleteStaffConfirm.name}</strong>? This action cannot be undone.
                </p>
                <div className="flex space-x-3">
                  <button
                    onClick={() => handleDeleteStaff(deleteStaffConfirm.id)}
              ...
              <form onSubmit={handleAllocateBudget} className="space-y-4">
                <div>
                  ...
                  >
                    ...
                    <option value="MMIDS Project">MMIDS Project</option>
                    {projects.map((project) => (
